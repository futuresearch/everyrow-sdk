...
description: "Each LLM provider has its own opinions about what valid means for JSON Schema, tool calling, caching, and temperature. Here are the quirks we've found running tens of thousands of LLM calls per day across Anthropic, Google, and OpenAI."
date: "2026-02-24"
...
- [Anthropic Is the Only Frontier Lab Where Reasoning Effort Scales on Deep Research Bench](/effort-scaling)
- [Higher effort settings in LLMs can reduce accuracy](/effort-paradox)
- [Deep Research Benchmark: Evaluating LLM Web Research Agents](/deep-research-bench)
