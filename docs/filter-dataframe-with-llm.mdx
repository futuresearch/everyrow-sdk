...
Download the dataset: [hn_jobs.csv](https://media.githubusercontent.com/media/futuresearch/everyrow-sdk/refs/heads/main/docs/data/hn_jobs.csv) (3,616 Hacker News "Who's Hiring" posts, March 2020 through January 2026). With the CSV in your working directory, tell Claude:

```
Screen hn_jobs.csv to find job postings that meet ALL THREE criteria:
...
├─ input_csv: "/Users/you/hn_jobs.csv"
...
Download the dataset: [hn_jobs.csv](https://media.githubusercontent.com/media/futuresearch/everyrow-sdk/refs/heads/main/docs/data/hn_jobs.csv) (3,616 Hacker News "Who's Hiring" posts, March 2020 through January 2026).
