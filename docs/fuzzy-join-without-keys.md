...
We'll use two datasets of S&P 500 companies from different sources. Download [company_info.csv](../notebooks/merge/company_info.csv) and [valuations.csv](../notebooks/merge/valuations.csv), or run the [full notebook](../notebooks/merge/deep_merge_tutorial.ipynb).
...
See the full analysis with multiple experiments in the [merge tutorial notebook](../notebooks/merge/deep_merge_tutorial.ipynb).
