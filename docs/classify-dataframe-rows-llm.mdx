...
Download the dataset: [hn_jobs.csv](https://media.githubusercontent.com/media/futuresearch/everyrow-sdk/refs/heads/main/docs/data/hn_jobs.csv) (3,616 Hacker News "Who's Hiring" posts). With the CSV in your working directory, tell Claude:

```
Classify each row in hn_jobs.csv by primary engineering role. Use these categories:
