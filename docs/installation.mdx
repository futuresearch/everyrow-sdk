...
## Sample output (Claude Code)

After installing the Claude Code plugin, try an operation:

> "Find the headquarter city and country for each company in companies.csv"

Here's what you'll see in Claude Code:

```
⏺ everyrow_agent
  ⎿  Submitted: 21 agents starting.
     Session: https://everyrow.io/sessions/df2b0daa-...

⏺ everyrow_progress
  ⎿  Running: 4/21 complete, 4 running (16s elapsed)

⏺ everyrow_progress
  ⎿  Running: 17/21 complete, 4 running (46s elapsed)

⏺ everyrow_progress
  ⎿  Completed: 21/21 (0 failed) in 63s.

⏺ everyrow_results
  ⎿  Saved 20 rows to /Users/you/demo_results.csv
```
