...
if TYPE_CHECKING:
    ...
    from ..models.rank_operation_response_schema_type_0 import (
...
class RankOperation:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.rank_operation_input_type_1_item import (
        ...
        def _parse_input_(
            data: object,
        ) -> list[RankOperationInputType1Item] | RankOperationInputType2 | UUID:
            try:
            ...
            try:
                ...
                for input_type_1_item_data in _input_type_1:
                    input_type_1_item = RankOperationInputType1Item.from_dict(
        ...
        def _parse_response_schema(
            data: object,
        ) -> None | RankOperationResponseSchemaType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                response_schema_type_0 = RankOperationResponseSchemaType0.from_dict(
                    data
                )
