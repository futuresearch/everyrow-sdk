...
ENGINE_RESPONSE = {
    "upload_url": "https://futuresearch.ai/api/v0/uploads/abc-123?expires=9999&sig=xyz",
    "upload_id": "abc-123",
    "expires_in": 300,
...
class TestRequestUploadUrlTool:
    ...
    async def test_returns_upload_url(self):
        ...
        with patch("futuresearch_mcp.uploads.httpx.AsyncClient") as mock_httpx:
            mock_http = AsyncMock()
    ...
    async def test_api_url_construction(self):
        ...
        with (
            override_settings(
                futuresearch_api_url="https://custom-engine.example.com/api/v0"
            ),
...
class TestRewriteUploadUrl:
    ...
    def test_rewrites_host_and_path(self):
        engine_url = (
            "https://futuresearch.ai/api/v0/uploads/abc-123?expires=9999&sig=xyz"
        )
    ...
    def test_preserves_query_params(self):
        engine_url = (
            "https://futuresearch.ai/api/v0/uploads/id-1?expires=100&sig=abc&extra=val"
        )
    ...
    def test_handles_tunnel_url_with_port(self):
        engine_url = "https://futuresearch.ai/api/v0/uploads/id-1?expires=1&sig=s"
