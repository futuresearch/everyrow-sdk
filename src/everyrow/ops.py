...
async def merge(
    ...
    Args:
        ...
        use_web_search: Control web search behavior: "auto" (default) tries LLM merge first then conditionally searches, "no" skips web search entirely, "yes" forces web search without initial LLM merge
